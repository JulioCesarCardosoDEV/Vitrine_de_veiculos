package com.juliocesar.webpage.security.util;
...
public class TokenUtil {
    ...
    private static String createToken(User obj) {
    ...
    public static Authentication validate(HttpServletRequest request) {
        ...
        Jws<Claims> jwsClaims = Jwts.parser().setSigningKey(SECRET_KEY.getBytes())
                .build()
